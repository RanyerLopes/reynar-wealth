...
export const BANK_PROFILES: Record<string, BankProfile> = {
    ...
    next: {
        ...
        thousandsSeparator: '.',
        columnMappings: { date: 0, description: 1, amount: 2 },
        detectPattern: /next|banco next/i,
    },
    pagbank: {
        name: 'PagBank',
        country: 'BR',
        ...
        thousandsSeparator: '.',
        columnMappings: { date: 0, description: 1, amount: 2 },
        detectPattern: /pagbank|pagseguro/i,
    },
    mercadopago: {
        name: 'Mercado Pago',
        country: 'BR',
        ...
        thousandsSeparator: '.',
        columnMappings: { date: 0, description: 1, amount: 2 },
        detectPattern: /mercado pago|mercadopago|mercadolivre/i,
    },
    picpay: {
        name: 'PicPay',
        country: 'BR',
    ...
    xp: {
        ...
        thousandsSeparator: '.',
        columnMappings: { date: 0, description: 1, amount: 2 },
        detectPattern: /xp investimentos|xp banco/i,
    },
    sofisa: {
        name: 'Sofisa Direto',
        country: 'BR',
